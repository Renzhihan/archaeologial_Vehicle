...
class ChassisExecutor{
  ...
  typedef actionlib::SimpleActionClient<move_base_msgs::MoveBaseAction> GlobalActionClient;
 ...
 public:
   ...
   */
  void Execute( yhs_can_msgs::ctrl_cmd &twist);
  /**
  ...
  void HwCallBack(const yhs_can_msgs::hw::ConstPtr & hw);
 ...
 private:
   ...
   */
  void GlobalPlannerFeedbackCallback(const move_base_msgs::MoveBaseFeedbackConstPtr& global_planner_feedback);
  ...
  actionlib::SimpleActionClient<move_base_msgs::MoveBaseAction> global_planner_client_;

  //! global planner actionlib goal
  //roborts_msgs::GlobalPlannerGoal global_planner_goal_;
  move_base_msgs::MoveBaseGoal global_planner_goal_;
  //! local planner actionlib goal
  double v1_;
  double v2_;
  yhs_can_msgs::ctrl_cmd zero_twist_;
