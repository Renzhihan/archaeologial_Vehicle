...
int main(int argc, char** argv) try
{
    ...
    while(1)
    {
        ...
        cv::line(pic_depth,Point(0,160),Point(640,160),Scalar(0));
        cv::line(pic_depth,Point(0,320),Point(640,320),Scalar(0));
        cv::line(pic_depth,Point(280,0),Point(280,640),Scalar(0));
        cv::line(pic_depth,Point(360,0),Point(360,640),Scalar(0));

        Mat depth_1=pic_depth(Rect(0,0,280,160));
        //Mat depth_2=pic_depth(Rect())
        // Display in a GUI
